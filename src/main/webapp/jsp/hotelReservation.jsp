...
<input type="radio" class="form-check-input" id="roomSize1" name="roomSize" value="Double Full"/>
<label for="roomSize1" class="form-check-label">Double Full</label>
</div>

<%--Queen --%>
<div class ="radioButton form-check ms-3">
<input type="radio" class="form-check-input" id="roomSize2" name="roomSize" value="Queen"/>
<label for="roomSize2" class="form-check-label">Queen</label>
</div>

<%--Double Queen --%>
<div class ="radioButton form-check ms-3">
<input type="radio" class="form-check-input" id="roomSize3" name="roomSize" value="Queen Double"/>
<label for="roomSize3" class="form-check-label">Queen Double</label>
</div>

<%--King --%>
<div class ="radioButton form-check ms-3">
<input type="radio" class="form-check-input" id="roomSize4" name="roomSize" value="King"/>
<label for="roomSize4" class="form-check-label">King</label>
</div>
...
<input type="checkbox" class="form-check-input" id="amenities1" name="amenities[]" value="Wi-Fi"/>
<label class="form-check-label" for="amenities1">Wi-Fi ($12.00)</label>
</div>

<%--Breakfast --%>
<div class="checkbox form-check ms-3">
<input type="checkbox" class="form-check-input" id="amenities2" name="amenities[]" value="Breakfast"/>
<label class="form-check-label" for="amenities2">Breakfast ($8.99)</label>
</div>

<%--Parking --%>
<div class="checkbox form-check ms-3">
<input type="checkbox" class="form-check-input" id="amenities3" name="amenities[]" value="Parking"/>
<label class="form-check-label" for="amenities3">Parking ($19.99)</label>
</div>
...
<div class="date ms-3">
<input type="date" class="form-control" id="chek-in" name="check-in"/>
</div>
</div>
...
<div class="date ms-3">
<input type="date" class="form-control" id="chek-out" name="check-out"/>
</div>
</div>
