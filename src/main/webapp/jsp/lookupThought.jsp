...
<body>
	...
	String sql = String.format("SELECT r.`reservation_id`,r.`check_in_date`, r.`check_out_date`,r.`total_price`,s.`room_size_description`,g.`guest_count`,a.`amenity_description`" 
			...
			+" INNER JOIN amenities AS a ON a.amenity_id = i.amenity_id WHERE r.reservation_id = %d;",reservation_id);
